...
export const programs: Program[] = [
  {
    ...
    overview: [
      ...
      'It reaches past the back office, too: a private-events pipeline with banquet event orders and e-signed proposals, an online-order queue, a fee-free bilingual booking widget, guest marketing that segments itself, menu engineering, and a multi-location portfolio that puts every P&L side by side.',
    ],
    story: {
    ...
    modules: [
      ...
      { name: 'Scheduling & Labor', desc: 'Draft→publish schedules, a shift-swap marketplace with approvals, time clock, a demand forecast that suggests hours by role, and overtime flagged before it’s worked.' },
      ...
      { name: 'Financials & P&L', desc: 'A live, computed prime cost (accrual COGS + labor with burden), a daily flash, budget-vs-actual, CSV/GL export, and a multi-location portfolio putting every P&L side by side.' },
      ...
      { name: 'Team, Comms & Integrations', desc: 'Channels and a manager logbook with automated posts, plus webhook adapters for Toast, Square, Lightspeed, Lavu, Olo & QuickBooks — each with its own signed secret and kill-switch.' },
    ],
    pricing: [
