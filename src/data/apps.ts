...
export const apps: App[] = [
  ...
  // ── Health & Fitness ────────────────────────────────────────────────────────
  {
    ...
    screenshots: [
      { src: '/apps/quitline/screens/onboarding.webp', alt: 'Quitline — quit anything, watch it add up' },
      { src: '/apps/quitline/screens/progress.webp', alt: 'Quitline — your progress across every quit' },
      { src: '/apps/quitline/screens/tracker.webp', alt: 'Quitline — a live counter of clean time, money saved and more' },
      { src: '/apps/quitline/screens/craving.webp', alt: 'Quitline — a craving panic button with a 60-second breathing exercise' },
      { src: '/apps/quitline/screens/insights.webp', alt: 'Quitline — lifetime impact: money saved, time reclaimed and best streak' },
    ],
  ...
  },
  {
    ...
    screenshots: [
      { src: '/apps/roastline/screens/welcome.webp', alt: 'Roastline — the habit tracker that actually keeps you honest' },
      { src: '/apps/roastline/screens/coach.webp', alt: 'Roastline — pick your coach: Gentle, Sarcastic or Brutal' },
      { src: '/apps/roastline/screens/tracking.webp', alt: 'Roastline — track habits, water, minutes, pages or steps' },
      { src: '/apps/roastline/screens/roasts.webp', alt: 'Roastline — opt into roast-style reminders' },
      { src: '/apps/roastline/screens/dashboard.webp', alt: 'Roastline — your daily dashboard with a coach that calls you out' },
    ],
    legalLastUpdated: '2026-07-19',
    legal: { dataModel: 'local-only', usesSubscriptions: true, usesNotifications: true },
  },
  ...
  // ── Utilities ───────────────────────────────────────────────────────────────
  {
    ...
    screenshots: [
      { src: '/apps/fate/screens/home.webp', alt: 'Fate — pick a wheel, coin flip or dice roll' },
      { src: '/apps/fate/screens/templates.webp', alt: 'Fate — ten ready-to-go decision templates' },
      { src: '/apps/fate/screens/wheel.webp', alt: 'Fate — spin a custom decision wheel' },
      { src: '/apps/fate/screens/coin.webp', alt: 'Fate — flip a coin' },
      { src: '/apps/fate/screens/dice.webp', alt: 'Fate — roll the dice' },
    ],
    legalLastUpdated: '2026-07-19',
    legal: { dataModel: 'standard', usesSubscriptions: true, usesNotifications: false },
  },
